...
create table TESTS
(
	ID_QUESTION int constraint TESTS_PK  primary key,
...
insert into TESTS(ID_QUESTION, SUBJECT, QUESTION, ANSWER, NOANSWER1, NOANSWER2, NAMEQUESTION)
	values(1, 'ОАиП', 'Какое из предложенных выражений может быть использовано в качестве условий?', '(х<-3) или (х<>5)', 't*4-3', 'х-у', 'ОАиП1'),
		  (2, 'ОАиП', 'Программа, обеспечивающая последовательный "перевод" команд на машинный язык с их выполнением', 'компилятор', 'интерпретатор', 'компрессор', 'ОАиП2'),
		  (3, 'ОАиП', 'К свойствам алгоритма относится?', 'массовость, дискретность, результативность, детерминированность', 'дискретность, массовость, абсолютность, информативность, формальность', 'результативность, дискретность, массовость', 'ОАиП3'),
